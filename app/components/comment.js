...
export default class Comment extends React.Component {
  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.props.feedId, this.props.index, 4, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.props.feedId, this.props.index, 4, callbackFunction);
      }
    }
  }
  /**
   ...
   */
  didUserLike() {
    var likeCounter = this.state.likeCounter; // problem is here?
    var liked = false;
